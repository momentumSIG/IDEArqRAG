...
from src.config import WEAVIATE_URL, collection_name, RESULTS_DIR
...
class Config:
    ...
    # Weaviate collections mapping (uses config.py collection_name function)
    WEAVIATE_COLLECTIONS = {
        'all-MiniLM-L6-v2': collection_name('all-MiniLM-L6-v2'),
        'e5-large-instruct': collection_name('gte-multilingual-base'),
        'gte-multilingual-base': collection_name('gte-multilingual-base'),
    }
